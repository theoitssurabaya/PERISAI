export const s = {
  ...
  navActive: 'border-l-4 border-[#3B82F6] bg-blue-50 text-[#3B82F6]',
  navInactive: 'hover:bg-gray-100 text-[#0F172A]',

  // buttons
  btnPrimary: 'bg-[#3B82F6] text-white font-medium px-5 py-2 rounded-xl hover:bg-blue-600 transition-colors',
  btnSecondary: 'bg-gray-100 hover:bg-gray-200 text-[#0F172A] font-medium px-4 py-2 rounded-xl transition-colors',
